...
/**
 * Provides a 'Node field is empty' condition.
 *
 * @Condition(
 *   id = "node_field_is_empty",
 *   label = @Translation("Node field is empty")
 * )
 */
class NodeFieldIsEmpty extends ConditionPluginBase implements ContainerFactoryPluginInterface
{
